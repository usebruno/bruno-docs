...
- [Mock with Response Examples](./tutorial/mock-from-response-examples) - save collection examples and turn them into a local mock
- [Mock with OpenAPI](./tutorial/mock-from-openapi) - generate a mock from an OpenAPI spec
