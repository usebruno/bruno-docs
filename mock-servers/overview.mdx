...
- [Create a mock server from a collection](/tutorial/mock-from-response-examples) - create a mock server from a collection.
- [Create a mock server from an API spec](/tutorial/mock-from-openapi) - create a mock server from an API spec.
