...
- [Create a mock server](./create-mock-server) - create a mock server from a collection or an API spec, then start and use the base URL
- [Run a mock server](./run-mock-server) - interface walkthrough, server controls, request log, response examples, and more.
- [Create a mock server from a collection](/mock-servers/tutorial/mock-from-response-examples) - create a mock server from a collection.
- [Create a mock server from an API spec](/mock-servers/tutorial/mock-from-openapi) - create a mock server from an API spec.
