...
1. Click the **+** icon next to **Mock Servers** in the sidebar.
2. Enter a **name**. Set the source to **API Spec** and select the spec you want to generate from.
3. Optionally open **Advanced settings** to set the **port** and **response delay (ms)**.
4. Click **Create**.
