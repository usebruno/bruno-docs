...
Each mock response is presented as a first-class object with:
  ...
  - **Try** - lets you send a real request to this route and see the response in the Try Result tab without leaving the editor. The mock server must be running. Try requests follow all configured rules and are also recorded in the **[Request Log](/mock-servers/create-and-run#request-log-tab)**.
