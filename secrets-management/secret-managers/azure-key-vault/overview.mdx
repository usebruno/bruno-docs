...
[Azure Key Vault](https://learn.microsoft.com/en-us/azure/key-vault/general/overview) is a secure and scalable service designed to store and retrieve sensitive information such as API keys, database credentials, and other secrets. 
...
- [Integrating Azure Key Vault](./adding-a-secret-provider)
