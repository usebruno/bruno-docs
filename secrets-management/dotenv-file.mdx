...
If you manage `.env` variables through Bruno's UI, values containing special characters are automatically quoted when saved. If you edit the file manually, wrap values in double quotes when they contain any of the following:
