...
<Info>
  For extra security, integrate Bruno with your secret manager to store these values in a single location. Learn more [here](/v2/secrets-management/secret-managers/hashicorp-vault/overview).
</Info>
