...
![generate-code-pop-up](/v2/images/screenshots/send-request/rest/generate-code-pop-up.webp)

3. Select your desired programming language from the dropdown to generate the code snippet.

![generate-code-options](/v2/images/screenshots/send-request/rest/generate-code-options.webp)
