...
<img src="/v2/images/screenshots/sso-scim-management/okta/okta-sso-11.webp" alt="Bruno SAML SSO role mapping configuration showing Admin Roles and User Roles fields" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
