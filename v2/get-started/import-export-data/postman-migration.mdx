...
<div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', marginTop: '1rem' }}>
  <img
    src="/v2/images/screenshots/migration/postman/postman-pre-dropdown.webp"
    alt="Open the collection's dropdown menu"
    style={{ width: '500px', borderRadius: '0.5rem' }}
  />
  <img
    src="/v2/images/screenshots/migration/postman/postman-dropdown.webp"
...
<img
  src="/v2/images/screenshots/migration/postman/postman-export-dialog.webp"
...
<img
  src="/v2/images/screenshots/migration/postman/postman-environment.webp"
...
![Import Environment New](/v2/images/screenshots/get-started/import-export/import-postman-environment/import-environment-new.webp)

5. Click on **Import environment**

![Import Postman Environment](/v2/images/screenshots/get-started/import-export/import-postman-environment/import-environment.webp)
...
![Bruno Environment](/v2/images/screenshots/get-started/import-export/import-postman-environment/import-postman-environment-bottom.webp)
