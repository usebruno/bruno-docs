...
- Bruno Collection
- Postman Collection — folders are sorted alphabetically before requests, and requests are ordered by their sequence number for consistent output
...
![ExportDialog](/v2/images/screenshots/get-started/import-export/export_collection/1-share-export.webp)

3. You can then chose the format you'd like to export to and then designate a location for the file to be saved.

![ExportModal](/v2/images/screenshots/get-started/import-export/export_collection/2-export-options.webp)
