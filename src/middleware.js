...
const redirects = {
  ...
  '/migration-imports/postman': '/get-started/import-export-data/postman-migration',

  '/migration-imports/introduction': '/get-started/import-export-data/import-collections',

  '/get-started/import-export-data/safe-mode': '/get-started/javascript-sandbox',
  ...
  '/scripting/response/response-object': '/testing/script/response/response-object',
  ...
  '/scripting/response/response-query': '/testing/script/response/response-query',

  '/scripting/javascript-reference.html': '/testing/script/javascript-reference',
  ...
  '/license-management/golden-edition/individual/activate-license': '/license-management/overview',

  '/license-management/organization/manage-licenses': '/license-management/overview',

  '/license-management/organization/activate-license': '/license-management/overview',
