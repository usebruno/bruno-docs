...
[Global environment](../variables/global-environment-variables.mdx) variables are stored with OS-level encryption for security purposes and these variables are not available in the editor.
</Callout>
