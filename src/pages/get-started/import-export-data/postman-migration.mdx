...
> We're constantly improving on the fidelity of Postman imports, but sometimes you may see issues with scripts written in Postman. 
> Although we have a translator built for this, it's always good practice to review the collections after import, especially if you are using deprecated Postman syntax in your scripts. 
