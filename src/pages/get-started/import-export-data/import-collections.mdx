...
Postman Data Export has [additional steps <strong><sup>↗</sup></strong>](https://docs.usebruno.com/get-started/import-export-data/postman-migration) in the import process.
