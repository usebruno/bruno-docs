...
<Image src="/screenshots/sso-scim-management/okta/okta-swa-15.webp" alt="License portal login" width={800} height={600} className="rounded mt-4" />

<Image src="/screenshots/sso-scim-management/okta/okta-swa-16.webp" alt="License portal login" width={800} height={600} className="rounded mt-4" />
