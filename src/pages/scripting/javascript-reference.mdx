...
### Runtime Variables
Bruno allows you to get and set runtime variables on the fly. The runtime variables take precendence over environment variables.
...
#### `getRequestVar`
Get the request variable (set in the pre-request vars section)
