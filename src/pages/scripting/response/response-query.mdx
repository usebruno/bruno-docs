...
<BetaCard
  className="mt-4"
  color="warning"
  title="Response queries are temporarily not working as expected. We are working on a fix."
  badge="Beta"
  tooltip="Response queries currently work only in the assertions tab. You can still access the body, headers and status from res."
/>
# Response Query
