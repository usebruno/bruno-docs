...
After completing the above steps, your collection will be connected to GitHub. We have to **add and commit** (refer below section) some changes to pushed collection to GitHub.
