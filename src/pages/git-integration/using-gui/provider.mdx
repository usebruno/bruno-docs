...
1. Open **Git initialized** Bruno collection.
2. Click on **main** (top right corner).
3. Select **Remotes** from the dropdown.

![remotes](/screenshots/git-integration/git-gui/git-remote-option.webp)

4. Click on **Add Remote** button.

![remotes](/screenshots/git-integration/git-gui/add-remote.webp)

5. Enter **Remote Name** and **URL** and click on save.

![remotes](/screenshots/git-integration/git-gui/add-remote-url.webp)

After completing the above steps, your collection will be conected to GitHub. We have to **add and commit** (refer below section) some changes to pushed collection to GitHub.
