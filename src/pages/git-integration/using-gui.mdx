...
- [Branch Creation and Checkout](#creating-branch)
...
> You can commit all changes in single click by pressing **Add All Changes** button.
...
3. Click on 'Import Collection'
4. Select 'Clone Git Repository'

5. Enter the Repository URL

6. Select Location for Cloned Collection and Click on Clone
   

7. Select the Collection and Click 'Open'.
