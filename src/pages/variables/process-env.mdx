...
Process environment variables are used to store sensitive information, such as API keys, passwords, and other secret values. These values are typically stored in a .env file. For more details on secret management, refer to the [secret management](https://docs.usebruno.com/secrets-management/dotenv-file) section.
...
![image](/screenshots/variables/creating-process-env-variables.png)
...
![image](/screenshots/variables/using-process-env-variables.png)
