...
<Image src="/screenshots/sso-scim-management/okta/okta-swa-4.webp" alt="License portal login" width={800} height={600} className="rounded mt-4" />
...
<Image src="/screenshots/sso-scim-management/okta/okta-swa-6.webp" alt="License portal login" width={800} height={600} className="rounded mt-4" />
