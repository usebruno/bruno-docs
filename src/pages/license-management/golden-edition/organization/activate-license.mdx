...
![login](/screenshots/license-management/golden-edition/organization/click-license-icon.png)

### Step 2: Select Organization License

Select the organization option to continue with the organization license activation.

![login-otp](/screenshots/license-management/golden-edition/organization/select-org-license.png)
...
![login-otp](/screenshots/license-management/golden-edition/organization/enter-license-details.png)

### Step 4: License Activated

Once the license is activated, you will see a success message.

![login-otp](/screenshots/license-management/golden-edition/organization/license-activated.png)
