...
<video controls className="mt-10">
  <source src="/screenrecordings/vault/add-a-secret-provider.mp4" type="video/mp4" />
...
<video controls className="mt-10">
  <source src="/screenrecordings/vault/add-cloud-secret-provider.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>
