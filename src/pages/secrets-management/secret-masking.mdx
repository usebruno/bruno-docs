# Bruno Secret Masking Documentation

## Overview

Bruno automatically masks sensitive information in requests, responses, and reports to protect your secrets from being exposed. This documentation explains what gets masked.
...
- **HTML reports** (when generated from app)
- **JSON reports** (when generated from app)
- **JUnit reports** (when generated from app)
