...
- `assertions` : An array containing any assertions associated with the request. _See [assertions](../../tests/assertions)_.
...
- `vars` : An object containing any variables associated with the request. _See [variables](../../script/vars)_.
