...
To use dynamic variables in pre-request or post-response scripts, use bru.interpolate(). For example, to enter a random first name, use bru.interpolate('{{$randomFirstName}}').
