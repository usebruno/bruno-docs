...
In this example we're using [Spectral CLI](https://github.com/stoplightio/spectral?tab=readme-ov-file) as a npm package which help you to valide OpenSpec API YAML or JSON files with the built-in ruleset. 
