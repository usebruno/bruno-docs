...
The **Bruno Runner** feature allows you to iterate over data files, making it easy to automate and manage data-driven requests. Bruno supports both CSV and JSON files for running requests, so you can efficiently run tests or process multiple data inputs.

# Introduction 

  In this tutorial, we'll explore the Bruno Runner feature, which enables you to iterate over multiple files. We'll be using the [ReqRes](https://reqreq.in) API to demonstrate how it works, but you can use any API of your choice.
...
- **Using the Command Line Interface (CLI)**
 ...
 > You will need a CSV or JSON file with sample data. 
