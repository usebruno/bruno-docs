...
When you upload a CSV or JSON file, the variables within the file can be used as runtime variables within your API requests or scripts. You can access these variables dynamically in your requests and use them within Bruno scripts.
