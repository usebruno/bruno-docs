...
We have plans to support gRPC, WebSocket, and MQTT.  We have a [public rolling roadmap](https://github.com/usebruno/bruno/discussions/1) that includes some of the bigger items we're working on.
