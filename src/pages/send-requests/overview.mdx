...
We have plans to support gRPC, WebSocket, and MQTT.  We have a [public rolling roadmap](https://www.usebruno.com/roadmap) that includes some of the bigger items we're working on.
