...
<a href="/files/oauth2/password-credentials-collection-level.json" download="oauth2-password-credentials-collection-level.json" className="mt-2">
...
<a href="/files/oauth2/password-credentials-request-level.json" download="oauth2-password-credentials-request-level.json" className="mt-2">
  <div className="hover:underline w-fit border border-slate-500 rounded-md py-1 px-2 flex flex-row justify-center items-center gap-2">
    <div className="mt-1 w-fit">Download</div>
    <svg
        width={20}
