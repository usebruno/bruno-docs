...
<video controls className="mt-10">
  <source src="/screenrecordings/oauth2/authorization-code-collection-level.mp4" type="video/mp4" />
...
<video controls className="mt-10">
  <source src="/screenrecordings/oauth2/authorization-code-request-level.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>
