...
<Callout>
  Some APIs will require a digital certificate to establish a client's identity. You can add your
  certificate authority (CA) or client certificates to Bruno. See [Add and Manage
  Certificates](./add-and-manage-certs) for more information.
</Callout>
