...
OAuth2 authentication can be implemented in various ways, depending on the collection structure and specific requirements. You can configure OAuth2 at:
- [Collection Level](/auth/oauth2-experimental/collection-level-configuration)
- [Folder Level](./folder-level-configuration.mdx)
- [Request Level](/auth/oauth2-experimental/request-level-configuration)
