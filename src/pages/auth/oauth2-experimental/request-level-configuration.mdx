...
You can manually reference the request's OAuth2 token in your requests using the variable format `{{$oauth2.credentials.access_token}}` in either headers or query parameters.
