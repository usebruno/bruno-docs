...
<Info>
  For detailed instructions on importing and exporting collection environment variables, see the [Import/Export Environments](/v3/get-started/import-export-data/import-export-environments) guide.
</Info>
