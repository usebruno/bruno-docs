...
<Info>
  **Bruno 3.0.0+**: Global environments are now stored within each [workspace](/v3/get-started/bruno-basics/create-a-workspace) in the `environments/` folder, making them version-controllable and workspace-scoped.
...
<Info>
  For detailed instructions on importing and exporting global environment variables, see the [Import/Export Environments](/v3/get-started/import-export-data/import-export-environments) guide.
</Info>
