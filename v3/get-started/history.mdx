...
![navigate history](/images/images/screenshots/get-started/history/navigate-history.webp)

3. You will have access to the complete request activity log.

![navigate history](/images/images/screenshots/get-started/history/history_log.webp)
