...
<Card
  ...
  icon="github"
  iconType="brands"
  href="https://github.com/bruno-collections"
>
  Want to see Bruno in action? Bruno Public Collections is a GitHub repository
  of ready-to-use API collections. Clone one and open it in Bruno to test APIs.
</Card>
