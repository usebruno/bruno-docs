...
If you have completed all the challenges, you can submit your challenge by exporting your collection as an OpenAPI document (refer challenge 12) and submitting it to the challenge submission folder with your name `<your-name.yaml>` in **bruno-starter-guide** repository.
