...
1. **Fetch in Bruno** button to open the collection in Bruno, **or** git clone the repository [Bruno Starter Guide](https://github.com/bruno-collections/bruno-starter-guide).
...
Read more about collection runner: [Collection Runner](/get-started/bruno-basics/run-a-collection)
