...
| [View Diffs](./provider#viewing-diffs) | See changes made to your collection files (text-based diff) |
| [Check for Updates](./consumer#checking-for-updates) | Check if remote repository has new changes |
| [Pull Changes](./consumer#pulling-changes) | Download and apply remote changes from the branch your current branch tracks |
...
| Feature | Description |
|---------|-------------|
| [Visual-Based Diff View](./provider#visual-based-diff-view) | Review collection changes in a visual, structural layout instead of line-by-line text |
...
| [Create a Pull Request](./provider#create-a-pull-request-on-github) | Create a GitHub pull request and browse open and closed PRs from the Git UI (Bruno 4.2.0+) |
| [Pull or Push from Any Branch](./provider#pushing-changes) | Choose the remote and branch to pull from or push to, instead of only the tracked branch |
