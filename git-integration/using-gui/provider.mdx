...
Creating a pull request used to mean leaving Bruno and opening GitHub in the browser after you pushed a branch. That context switch breaks the Git flow you already have in the Git UI.
...
From **4.2.0**, the Git UI sidebar includes a **Pull Requests** item under **Links**, below **Commits**. Open it to browse open and closed pull requests for the current repository.
...
After a successful push, Bruno prompts you to open a pull request for that branch — for example, **Open a pull request for feat/add-auth?** — with a **Create Pull Request** button.

![Create pull request prompt after pushing a branch](/images/screenshots/v4/git-integration/create-pull-request-prompt.webp)

4. Click **Create Pull Request**.
5. Enter a **title** and **description**.
6. Review the commit messages and the changes in those commits.
7. Click **Create Pull Request** to submit.

Bruno creates the pull request against the GitHub remote and the repository's base branch, then surfaces the PR URL in the Git UI.

8. Click **Open in GitHub** if you want to view the pull request in the browser.
