...
![Save Response](/screenshots/send-request/res-data-and-cookie/save-response.webp)

4. **Enter a name** for your example in the dialog that appears
5. **Click Save** to create the example

![Save Response Dialog](/screenshots/send-request/res-data-and-cookie/save-response-dialog.webp)
...
![Response Example](/screenshots/send-request/res-data-and-cookie/save-response-example.webp)
