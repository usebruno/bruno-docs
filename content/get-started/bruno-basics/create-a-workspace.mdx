...
If you have an existing workspace folder (for example, cloned from a Git repository):
...
Once you've created a workspace, you can [create a collection](/get-started/bruno-basics/create-a-collection) inside it to start organizing your API requests.
