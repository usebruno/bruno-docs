...
![Environment Variables location](/screenshots/get-started/import-export/import-export-env/env-action.webp)

2. Click on **Configure** to access the environment settings.

3. You will see the **Import** and **Export** options in the left sidebar.

![Export Option](/screenshots/get-started/import-export/import-export-env/environment-tab.webp)
...
![Export env](/screenshots/get-started/import-export/import-export-env/click-export-option.webp)
