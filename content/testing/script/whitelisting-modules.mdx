...
<Callout type="info">
**Bruno v3.0.0 Update:** Starting with Bruno v3, we now use Node.js VM (Node VM) as the JavaScript sandbox. This means you no longer need to whitelist modules in most cases. The information on this page applies to Bruno v2 and earlier versions.
</Callout>
