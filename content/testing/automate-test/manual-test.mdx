...
![select-run.webp](/screenshots/get-started/bruno-basics/run_collection/run_collection.webp)

3. Click **Run Collection** to initiate the test.

![click-runner.webp](/screenshots/get-started/bruno-basics/run_collection/runner.webp)
