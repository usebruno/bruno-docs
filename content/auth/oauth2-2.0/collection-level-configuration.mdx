...
![Select OAuth Grant Type](/screenshots/auth/1-select-oauth-grant-type.webp)
...
![Select OAuth Grant Type](/screenshots/auth/get-access-token.webp)
...
![Auto-refresh Token](/screenshots/auth/auto-refresh.webp)
...
![Navigate Request and Select Inherit](/screenshots/auth/3-navigate-request-select-inherit.webp)
...
![Enter Details to Get Token](/screenshots/auth/2-enter-details-to-get-token.webp)
...
![Token Auto Added](/screenshots/auth/4-token-auto-added.webp)
...
![Get Access Token from Collection](/screenshots/auth/5-get-access-token-from-collection.webp)
...
![Directly Use Token in Query Params](/screenshots/auth/6-directly-use-token-query-params.webp)
