...
![Text-Based Diff](/screenshots/git-integration/git-gui/git-text-based-diff.webp)
...
![Visual-Based Diff](/screenshots/git-integration/git-gui/git-visual-based-diff.webp)
