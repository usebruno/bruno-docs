...
![Workspace Settings](/screenshots/send-request/api-docs/worskpace-settings.webp)

3. Add your documentation in the textarea section in markdown format.

![Add Documentation](/screenshots/send-request/api-docs/workspace-document.webp)
