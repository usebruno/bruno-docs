...
![Click Generate Docs](/screenshots/send-request/api-docs/opencollection/1-click-generate-docs.webp)

2. Click the **Generate** button to create the HTML documentation

![Click Generate Button](/screenshots/send-request/api-docs/opencollection/click-generate-2-button.webp)

3. Bruno will generate a HTML documentation file for your collection documentation

![Generated HTML Documentation](/screenshots/send-request/api-docs/opencollection/genarated-docs-htmml.webp)
...
![Test Scripts](/screenshots/send-request/api-docs/opencollection/curl.webp)
...
![Test Scripts](/screenshots/send-request/api-docs/opencollection/test-script-display.webp)
...
![Try It Out Playground](/screenshots/send-request/api-docs/opencollection/auto-docs-playground.webp)
