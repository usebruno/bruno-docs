...
Starting with Bruno v3.1.0, you can create, view, and delete environment variables directly from Bruno at the workspace level without manually editing `.env` files.
