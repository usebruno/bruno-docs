...
# Azure CLI Authentication <PremiumBadge noLink />
...
![Select Azure Key Vault Provider](/screenshots/secret-variables/azure-key-vault/3-select-azure-vualt-collection.webp)
