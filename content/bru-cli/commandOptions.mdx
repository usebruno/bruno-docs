...
| `--sandbox [string]`        | Javascript sandbox to use; available sandboxes are "safe" (default) or "developer" [string] [default: "safe"] <br/><br/>**Note:** From v3.0.0 onwards, the default is "safe" mode. Use `--sandbox=developer` for Developer Mode features. |
