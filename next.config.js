...
export default withNextra({
  ...
  async redirects() {
    return [
      ...
      { source: '/secrets-management/hashicorp-vault', destination: '/secrets-management/secret-managers/hashicorp-vault/overview', permanent: true },
      { source: '/secrets-management/hashicorp-vault/overview', destination: '/secrets-management/secret-managers/hashicorp-vault/overview', permanent: true },
      ...
      { source: '/secrets-management/hashicorp-vault/using-secrets', destination: '/secrets-management/secret-managers/hashicorp-vault/using-secrets', permanent: true },
      { source: '/secrets-management/hashicorp-vault/using-with-cli', destination: '/secrets-management/secret-managers/hashicorp-vault/using-with-cli', permanent: true },

      { source: '/secrets-management/aws-secrets-manager', destination: '/secrets-management/secret-managers/aws-secrets-manager/overview', permanent: true },
      { source: '/secrets-management/aws-secrets-manager/overview', destination: '/secrets-management/secret-managers/aws-secrets-manager/overview', permanent: true },
      ...
      { source: '/secrets-management/aws-secrets-manager/using-secrets', destination: '/secrets-management/secret-managers/aws-secrets-manager/using-secrets', permanent: true },

      { source: '/secrets-management/azure-key-vault', destination: '/secrets-management/secret-managers/azure-key-vault/overview', permanent: true },
      { source: '/secrets-management/azure-key-vault/overview', destination: '/secrets-management/secret-managers/azure-key-vault/overview', permanent: true },
      ...
      { source: '/secrets-management/azure-key-vault/using-secrets', destination: '/secrets-management/secret-managers/azure-key-vault/using-secrets', permanent: true },
    ];
  },
});
