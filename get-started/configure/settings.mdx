...
The Keybindings section provides details about Bruno's keyboard shortcuts. You can customize the keyboard shortcuts for different actions in the application.
1. Go to **Preferences** and click on **Keybindings**.
2. You will see the list of keyboard shortcuts for different actions in the application.
3. You can customize the keyboard shortcuts for different actions by clicking on the **Edit** button.
