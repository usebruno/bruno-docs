...
In Developer Mode, scripts also get Node-style `__dirname` and `__filename`, scoped to the executing `.bru` file. See [`__dirname` and `__filename`](/testing/script/javascript-reference#__dirname-and-__filename).
