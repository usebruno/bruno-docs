...
<Tabs>
  <Tab title="macOS">
    ...
    Download the latest macOS version from the [official downloads page <strong><sup>↗</sup></strong>](https://www.usebruno.com/downloads). The following installer formats are available for both Intel and Apple Silicon:

    - **`.pkg`** — Standard macOS installer package
