...
- **Open Collection** - Opens an existing Bruno collection (multiple open collections is supported).
- **Import Collection** - Imports an collection from other tools (Postman, GitHub Import, Insomnia, etc.).
