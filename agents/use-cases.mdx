...
For best results, ensure your agent's instruction file (e.g. Cursor's `instructions.md`, Claude's `CLAUDE.md`, or Codex's `AGENTS.md`) includes [Bruno's default prompts](https://github.com/bruno-collections/ai-assistant-prompts) or your own guidance for working with Bruno collections and CLI.
