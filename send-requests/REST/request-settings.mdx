...
**Configuration:**
- **Type**: Numeric input (whole numbers)
- **Range**: 0 or more (no upper bound)
- **Default**: 5 redirects

Fractional values are truncated. Negative, non-numeric, or non-finite values fall back to the default.
