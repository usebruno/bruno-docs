...
Bruno supports [Server-Sent Events (SSE)](/send-requests/REST/sse) for REST requests that stream data with `Accept: text/event-stream`. Incoming chunks appear live in the response panel, and you can cancel an active stream at any time.
