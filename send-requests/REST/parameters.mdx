...
3. Enter the **Name** of the parameter, corresponding **Value**, and an optional **Description** to document what the parameter represents.

![create-query-params](/images/screenshots/v4/description/query_param.webp)
...
![path-params](/images/screenshots/v4/description/path_param.webp)
