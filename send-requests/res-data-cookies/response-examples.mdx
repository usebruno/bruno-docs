...
<Tip>
  You can also save response example  from request context menu (... three dots) > **Create Example** without sending the request. Use this when you already know the status, headers, and body you want to mock.
</Tip>
