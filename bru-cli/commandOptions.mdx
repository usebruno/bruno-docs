...
| `--exclude-envs [a,b]`  | Leave the named environments out of the generated documentation (comma-separated).                                                                                        |
| `--tags [a,b]`          | Include only requests carrying any matching tag (comma-separated).                                                                                                        |
| `--exclude-tags [a,b]`  | Exclude requests carrying any matching tag (comma-separated). Exclusion wins when a request matches both include and exclude filters.                                     |
...
```bash
bru docs generate --envs "Production,QA Env" --exclude-tags WIP --no-git-link -o docs/api.html
```
