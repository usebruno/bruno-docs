...
<Note>
  ...
  upcoming features and provide feedback and not for production.
</Note>
...
The nightly binary is installed at `cli-portable-nightly/node_modules/.bin/bru`. When the collection lives in a **different folder**, use the full absolute path to that binary.
...
Desktop app nightlies are documented separately under [Download & Install](/get-started/bruno-basics/download#nightly-builds).