...
<Info>
  **Bruno never stores your API keys.** The keys stay on your
  machine and are not written to collections or Git. Bruno saves them locally in
  the same application-data folder as `preferences.json`, and it never leaves
  your machine except when Bruno talks to the provider you configured.
