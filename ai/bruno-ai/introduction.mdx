...
<Note>
  Bruno does not currently ship native Model Context Protocol (MCP) client or server support. Bruno AI connects directly to the providers listed above. Follow or upvote the tracking issue on GitHub ([usebruno/bruno#4806](https://github.com/usebruno/bruno/issues/4806)) for updates.
</Note>
