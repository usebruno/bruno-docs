...
<CardGroup cols={2}>
  ...
  >
    Install the extension from the marketplace and set up your workspace and
    collections.
  </Card>
  <Card
    title="Send Requests"
    icon="paper-plane"
    href="/vs-code-extension/send-req"
  >
    Send API requests and inspect responses directly from your editor.
  </Card>
</CardGroup>
